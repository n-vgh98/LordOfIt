...
@section('content')
    <section class="text-center">
        <div class="btn-group btn-group-toggle">
            <a href="{{ route('admin.work_samples.slider.index', 'fa') }}" class="btn btn-primary">فارسی</a>
            <a href="{{ route('admin.work_samples.slider.index', 'en') }}" class="btn btn-primary">انگلیسی</a>
        </div>
    </section>
                ...
                @if ($imagedetail !== null)
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('admin.work_samples.slider.destroy', $image->id) }}" method="post">
                                @csrf
                                @method("DELETE")
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('admin.work_samples.slider.update', $image->id) }}" method="POST"
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.work_samples.slider.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

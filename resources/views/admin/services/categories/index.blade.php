...
<table class="table table-striped">
    ...
    <tbody>
        ...
        <tr>
            <td>
                <form action="{{ route('services_categories.destroy', $category->id) }}" method="POST">
                    @csrf
                    @method("DELETE")
        ...
        <div class="modal fade" id="category{{ $category->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('services_categories.update', $category->id) }}"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="title" type="text"
                                                ...
                                                autocomplete="title" value="{{ $category->title }}" autofocus>
                                    ...
                                    <div class="form-group row">
                                        <label for="meta_keywords"
                                            class="col-md-4 col-form-label text-md-right">{{ __('meta_keywords') }}</label>

                                        <div class="col-md-6">
                                            <input id="meta_keywords" type="text"
                                                class="form-control @error('meta_keywords') is-invalid @enderror" name="meta_keywords"
                                                required value="{{ $category->meta_keywords }}" autocomplete="meta_keywords"
                                                autofocus>
                                    ...
                                    <div class="form-group row">
                                        <label for="meta_description"
                                            class="col-md-4 col-form-label text-md-right">{{ __('meta_description') }}</label>

                                        <div class="col-md-6">
                                            <input id="meta_description" type="text"
                                                class="form-control @error('meta_description') is-invalid @enderror" name="meta_description"
                                                required value="{{ $category->meta_description }}" autocomplete="meta_description"
                                                autofocus>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('services_categories.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="job_slugitle" type="text"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="meta_description" type="text"
                                    ...
                                    autocomplete="meta_description" autofocus></textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="meta_keywords" type="text"
                                    class="form-control @error('meta_keywords') is-invalid @enderror"
                                    name="meta_keywords" value="{{ old('meta_keywords') }}" required
                                    autocomplete="meta_keywords" autofocus></textarea>

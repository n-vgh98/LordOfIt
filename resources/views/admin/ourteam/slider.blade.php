...
@section('content')
    <section class="text-center">
        <div class="btn-group btn-group-toggle">
            <a href="{{ route('admin.ourteam.slider.index', 'fa') }}" class="btn btn-primary">فارسی</a>
            <a href="{{ route('admin.ourteam.slider.index', 'en') }}" class="btn btn-primary">انگلیسی</a>
        </div>
    </section>
                ...
                @if ($imagedetail !== null)
                    <tr>
                        ...
                        <td class="text-center">
                            <form action="{{ route('admin.ourteam.slider.destroy', $image->id) }}" method="post">
                                @csrf
                                @method("DELETE")
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('admin.ourteam.slider.update', $image->id) }}" method="POST"

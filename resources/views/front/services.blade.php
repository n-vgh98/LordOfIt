...
@foreach ($languages as $language)
            ...
            <section class="breadcrumb-section">
             ...
             <h1 class="main-title-h1"> {{$services->title}} </h1>
            <article class="article-wrapper-content">
                <section class="right-article-wrapper ">
                    
                    <div class="article-img-wrapper">
                        <figure>
                            <img src="{{$services->image->path}}" alt="{{$services->image->alt}}" title="{{$services->image->name}}">
                        </figure>
                    </div>
                    ...
                    <section class="article-text-wrapper">
                        ...
                        <div class="video-1 article-video">
                            <iframe src="{{$services->v_link_1}}"></iframe>
                        </div>
                        <div>
                        </div>
                        <div class="video-1 article-video">
                            <iframe src="{{$services->v_link_2}}"></iframe>
                        </div>
                        <div>
                            {{$services->text_3}}
                        </div>
                        <div class="video-1 article-video">
                            <iframe src="{{$services->v_link_3}}"></iframe>
                        </div>
                        <div>
                            {{$services->text_4}}
                        </div>
                        <div class="video-1 article-video">
                            <iframe src="{{$services->v_link_4}}"></iframe>
                        </div>
